...
GLOBAL_LIST_INIT(lizard_names_verbs, world.file2list("strings/names/lizard_verbs.txt"))
GLOBAL_LIST_INIT(lizard_names_nouns, world.file2list("strings/names/lizard_nouns.txt"))
